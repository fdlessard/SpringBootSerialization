...
public class WrapperDeserializer2<T> extends JsonDeserializer<T> implements ContextualDeserializer {
    ...
    public T deserialize(JsonParser parser, DeserializationContext deserializationContext) throws IOException {
        ...
        return oc.treeToValue(node.get("value"), typeParameterClass);
    }
}
